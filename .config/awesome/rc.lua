...
local theme_path = gears.filesystem.get_xdg_config_home() .. "awesome/theme/xresources/theme.lua"
beautiful.init(theme_path)

-- This is used later as the default terminal and editor to run.
terminal = "st -f \"MesloLGS NF\""
editor = "code-oss"
...
tyrannical.tags = {
  ...
  } ,
  {
    ...
    class = {
      ...
      "Chromium"      , "nightly"        , "minefield", "Brave-browser", "brave-browser", "firefoxdeveloperedition"     }
  } ,
  {
    name = "  ",
    init        = true,
    ...
    class  = {
      "Thunar", "Konqueror", "Dolphin", "ark", "Nautilus","emelfm", "lf"
    }
  } , --  "", "", "", "
  {
    name = "  ",
  ...
  --[[   exec_once   = {"code-oss"} ]]
    ...
    class ={
      "Kate", "KDevelop", "Codeblocks", "Code::Blocks" , "DDD", "kate4", "code-oss"}
  } ,
  {
    name        = "Doc",
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "[", function () beautiful.recolor_titlebar(theme_path, beautiful.xresources.get_current_theme) end,
              {description = "quit awesome", group = "awesome"}),
...
-- Also autorun these programs (easier to manage by hand)
...
-- Change border color when window is in focus, and again when it loses focus
